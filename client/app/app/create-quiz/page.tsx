        ...
        <main className="ml-64 p-8">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-light text-gray-100">Create New Quiz</h2>
              <button
                onClick={handleSubmit}
                disabled={isSubmitting}
                className="px-6 py-2 bg-pink-900/50 hover:bg-pink-800/50 text-pink-100 
                  rounded-lg transition flex items-center space-x-2 disabled:opacity-50 
                  disabled:cursor-not-allowed border border-pink-700/30"
              >
                {isSubmitting ? (
                  <span>Creating...</span>
                ) : (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-gray-800/50 border border-gray-700 
                      focus:border-pink-500/50 focus:ring focus:ring-pink-500/20 outline-none transition
            ...
            <div className="space-y-4">
              {quizData.questions.map((question, questionIndex) => (
                <div key={questionIndex} className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 border border-gray-800">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-lg font-medium text-gray-100">Question {questionIndex + 1}</span>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-gray-800/50 border border-gray-700 
                      focus:border-pink-500/50 focus:ring focus:ring-pink-500/20 outline-none transition
                      text-gray-100 placeholder-gray-500 mb-4"
              ...
              <button
                onClick={addQuestion}
                className="w-full px-4 py-3 bg-pink-900/30 hover:bg-pink-800/30 text-pink-300 
                  rounded-lg transition flex items-center justify-center space-x-2 border border-pink-700/30"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
